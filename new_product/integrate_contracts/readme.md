...
- List of contracts
  ...
  - Business Logic Contract: It executes the business logic of cross chain projects. It interacts with users and CCM contract both on source chain and target chain. See examples of business logic contract displaying cross chain features in following . 
