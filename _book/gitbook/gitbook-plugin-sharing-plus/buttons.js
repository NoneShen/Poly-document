require(['gitbook', 'jquery'], function(gitbook, $) {
    ...
    var SITES = {
        youtube: site('youtube', 'youtube', 'https://www.youtube.com/channel/UC4vFRyVgvK7RnlkkLDmp23w/featured'),
        medium: site('medium', 'medium', 'https://polynetwork.medium.com'),
        twitter: site('Twitter', 'twitter', 'https://twitter.com/PolyNetwork2'),
        discord: site('discord', 'discord', 'https://discord.com/invite/y6MuEnq'),
        telegram: site('telegram', 'telegram', 'https://t.me/polynetworkgroup'),
        github: site('github', 'github', 'https://github.com/polynetwork'),
